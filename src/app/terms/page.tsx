...
export default function TermsPage() {
  return (
    <div className="mx-auto h-dvh w-full max-w-[520px] overflow-y-auto overscroll-contain px-6 pb-16 pt-[max(env(safe-area-inset-top),24px)]">
      <div className="mb-5 flex items-center gap-3">
        <BackButton href="/mypage" />
        <h1 className="text-lg font-bold text-ink">이용약관</h1>
      </div>

      <p className="mb-6 text-xs text-ink-faint">시행일자: 2026년 9월 2일</p>
      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-ink-soft">
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제4조 (이용자의 의무)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제5조 (게시물의 관리)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제6조 (계정 관리 및 해지)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제7조 (지식재산권)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제8조 (면책조항)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제9조 (준거법 및 재판관할)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1.5 text-sm font-bold text-ink">제10조 (약관의 변경)</h2>
          <p>
