...
export function DeleteAccountButton() {
  ...
  return (
    <>
      <button type="button" onClick={() => setConfirming(true)} className="text-sm text-warn-ink underline">
        회원 탈퇴
      </button>
      ...
      {confirming && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
          ...
          <div className="relative w-full max-w-[360px] rounded-2xl bg-white p-5 shadow-xl">
            <p className="text-sm font-bold text-warn-ink">탈퇴하면 계정이 완전히 삭제돼요</p>
